$().ready(function(){
    if ($("#formDataCliente")) {
        if($("#dataTablePedidos") && $("#dataTablePedidos").attr("filterTable") == "Pendiente"){
            document.title = "Pedidos a Verificar";
            let totalPago = 0.0;
            let imgageComprobante = '';
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                $("#inputComprobante").val(dataPedido.path_comprobante);
                                imgageComprobante = dataPedido.path_comprobante;
                                if(imgageComprobante == "Sin adjuntar"){
                                    $("#btnViewComprobante").attr("disabled",true);
                                }
            ...
            $("#btnViewComprobante").on("click",function (e) {
                let dir_image = $("#imageComprobante").attr("data-dir");
                $("#imageComprobante").attr("src", dir_image + imgageComprobante)
            })
        }else if($("#dataTablePedidos") && $("#dataTablePedidos").attr("filterTable") == "Verificado"){
            document.title = "Pedidos Verificados";
            let totalPago = 0.0;
        $("#dataTablePedidos").on("click", "button.btnAction", function() {
            let idEditCliente = $(this).attr("idCliente");
            let idPedido = $(this).attr("idpedido");
        ...
        $(".btnEliminarPedido").on("click",function(e){
            ...
            let totalPago = 0.0;
            document.title = "Pedidos Enviados";
            $("#dataTablePedidos").on("click", "button.btnAction", function() {
                let idEditCliente = $(this).attr("idCliente");
                let idPedido = $(this).attr("idpedido");
                let infoData = {
