                                        ...
                                        <div class="row">
                                                ...
                                                <form method="POST" enctype="multipart/form-data" id="agregarFoto">
                                                    <div class="card text-center">
                                                        <div class="card-header bg-white">
                                                            <output id="imageUser">
                                                                <img src="<?php echo URL;?>uploads/perfiles/userDefault.png" data-dir="<?php echo URL;?>uploads/perfiles/" alt="" id="imgUser" class="img-thumbnail">
                                                            </output>
                                                        </div>
                                                        <div class="card-body">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" id="nombre" name="name" class="form-control form-control-lg">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" maxlength="10" minlength="10" id="dni" name="dni" class="form-control form-control-lg">
                                                </div>
                                                <div class="form-group mb-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" maxlength="10" minlength="10" class="form-control form-control-lg" name="celular" id="celular" disabled>
                                                </div>
                                                <div class="form-group mb-3">
...
<script>
    let id_usuario_logueado = <?php echo $_SESSION["id"];?>;
</script>
