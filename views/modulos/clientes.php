                                ...
                                <div class="modal-body">
                                    <form method="POST" id="formCliente">
                                        ...
                                        <div class="forn-group mb-3">
                                            ...
                                            <input type="text" name="" id="selectProvincia" class="form-control">
                                        </div>
                                        <div class="forn-group mb-3">
                                            <label for="inputCanton">Cantón</label>
                                            <input type="text" name="" id="selectCanton" class="form-control">
                                        </div>
                                        <div class="forn-group mb-3">
                                            <label for="inputParroquia">Parroquia</label>
                                            <input type="text" name="" id="selectParroquia" class="form-control">
                                        </div>
                                        <div class="form-group mb-3">
