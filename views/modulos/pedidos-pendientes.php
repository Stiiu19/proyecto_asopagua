        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-10">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control" disabled id="inputComprobante">
                                                                    <div class="input-group-append">
                                                                        <button type="button" class="btn btn-outline-secondary" id="btnViewComprobante" data-toggle="modal" data-target="#modalComprobante">
                    ...
                    <div class="modal fade" id="modalComprobante" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalCenterTitle">Comprobante adjunto</h5>
                                ...
                                <div class="modal-body">
                                    <div class="card border-0">
                                        <div class="card-body border-0">
                                            <div class="row">
                                                <div class="col">
                                                    <img src="" data-dir="<?php echo URL.'uploads/comprobantes/'?>"alt="" class="img-fluid" id="imageComprobante">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
