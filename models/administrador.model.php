...
class ModelAdministrador
{
    ...
    public static function mdlVerificarEmail($email){
     ...
     public static function mdlDeleteAdmin($id){
      try{
         $deleteHistorial = ModelAdministrador::mdlDeleteHistorialLogue($id);
   ...
   public static function mdlDeleteHistorialLogue($idUsuario){
      try{
         $query = Conexion::conectar()->prepare("DELETE FROM historial_logueo WHERE id_usuario=:idUsuario");
